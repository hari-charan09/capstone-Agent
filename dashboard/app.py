...
# ── Body / link / auth extraction helpers (replicated from gmail_mcp_server) ──
...
def _auth_result(header: str, proto: str) -> str:
    for m in _AUTH_RE.finditer(header):
        if m.group("proto").lower() == proto:
        ...
        for _, row in filtered.iterrows():
            ...
            <div class="email-card">
                ...
                <div class="meta-row">
                    ...
                    <span class="conf-pill" style="color:#475569; font-size:11px;">#{eid}</span>
                </div>
